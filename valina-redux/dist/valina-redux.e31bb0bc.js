...
var btnDecrease = document.querySelector('#decrease'); // Action Type 정의

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // Action 생성자 함수 정의
...
var store = (0, _redux.createStore)(reducer); // render 함수 생성(상태가 업데이트 될때마다 구독에 의해 호출되고 html을 사용해서 UI속성을 변경)

var render = function render() {
  var state = store.getState(); // store에서 현재 상태를 가져옴
...
render(); // render() 함수가 store.state가 변경될때마다 호출될수 있도록 store 내장함수인 구독을 사용

store.subscribe(render); // dispatch 생성 ( action을 발생시키는 함수 )
...
//# sourceMappingURL=/valina-redux.e31bb0bc.js.map