...
var btnDecrease = document.querySelector('#decrease'); // 액션(프로젝트의 상태에 변화를 일으킴) 타입들

var TOGGLE_SWITCH = 'TOGGLE_SWITCH';
var INCREASE = 'INCREASE';
var DECREASE = 'DECREASE'; // 액션 생성 함수. 반드시 type값을 가져야 하며 그 외 추후 상태를 업데이트할때 참고하고 싶은 값은 임의입력가능
